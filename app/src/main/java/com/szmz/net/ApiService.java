...
public interface ApiService {
    ...
    @POST("weixin/api/login.do?checkSmsCode")
    Call<CommResponse> getCheckCodeSQR_XJ(@Body Comm_checkCode_sqr_Req request);

    @POST("weixin/api/login.do?requestMobileCode")
