...
public class ActYZS_tj3 extends ActBase{
    ...
    private void getInfo(){
        ...
        Call<YZS_TJ3_Res> call = App.getApiProxyYZS().getYZS_tj3(req);

        ApiUtil<YZS_TJ3_Res>  apiUtil  = new ApiUtil<>(context,call,new SimpleApiListener<YZS_TJ3_Res>(){
            @Override
            public void doSuccess(YZS_TJ3_Res result) {
...
//        pieChart.setCenterText("救助金额统计");//设置环中的文字
