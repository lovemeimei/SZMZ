...
public class FragmentSearchYL_C extends BaseFragment {
    ...
    private BaseListAdapter<String ,FragmentSearchYL_C.MViewHolder> adapter;
    ...
    protected void bindDatas() {
        ...
        adapter = new BaseListAdapter<String, FragmentSearchYL_C.MViewHolder>(getContext(),R.layout.list_item_user_check) {
            @Override
            protected void refreshView(int postion, String item, FragmentSearchYL_C.MViewHolder holer) {
