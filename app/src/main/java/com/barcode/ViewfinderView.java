...
public final class ViewfinderView extends View {
	...
	public ViewfinderView(Context context, AttributeSet attrs) {
		...
		int center = resources.getColor(R.color.viewfinder_frame);
	...
	public void onDraw(Canvas canvas) {
		...
		if (resultBitmap != null) {
			...
			canvas.drawRect(frame.left - 5, frame.top - 5, frame.left + 10,
			        frame.top, paint);
			canvas.drawRect(frame.left - 5, frame.top - 5, frame.left,
			        frame.top + 10, paint);
			canvas.drawRect(frame.right - 10, frame.top - 5, frame.right + 5,
			        frame.top, paint);
			canvas.drawRect(frame.right, frame.top - 5, frame.right + 5,
			        frame.top + 10, paint);

			canvas.drawRect(frame.left - 5, frame.bottom + 5,
			        frame.left + 10, frame.bottom, paint);
			canvas.drawRect(frame.left - 5, frame.bottom + 5, frame.left,
			        frame.bottom - 10, paint);
			canvas.drawRect(frame.right - 10, frame.bottom + 5,
			        frame.right + 5, frame.bottom, paint);
			canvas.drawRect(frame.right, frame.bottom + 5, frame.right + 5,
			        frame.bottom - 10, paint);
